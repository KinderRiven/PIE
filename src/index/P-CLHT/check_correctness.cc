...
size_t key_len = 8;  // by default, WORT can only use 8B string value
...
void InitTest() {
  ...
  test_index = new PIE::CLHT::CLHTLBIndex(nvm_allocator, 64);
...
void DoInsert() {
  ...
  std::cout << "[WORT Finish Insertion]\n";
  std::cout << "---------------------------------------------------------------"
               "-----------------------\n";
  ...
  std::cout << "---------------------------------------------------------------"
               "-----------------------\n";
  // std::cout << "| |\n";
  std::cout << "| " << std::setw(strlen("   Index  ")) << "WORT"
