...
RHTreeLeaf *RHTreeIndex::normalsplit(RHTreeLeaf *leaf) {
  ...
  new_leaf->parent->SetChild(new_ptr_start,
                             new_ptr_start - 1 + (1 << new_ptr_num), new_leaf);
