#ifndef PIE_SRC_INCLUDE_INDEX_H__
#define PIE_SRC_INCLUDE_INDEX_H__
...
namespace PIE {
  ...
  class Index {
   ...
   public:  
    ...
    virtual status_code_t ScanCount(const char *startkey, size_t key_len, size_t count, void **vec) = 0;
